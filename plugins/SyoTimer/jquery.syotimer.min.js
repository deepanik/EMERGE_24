    ...
    var t = "day"
      ...
      , c = {
        ...
        _perSecondHandler: function() {
            ...
            a >= 0 ? (c._refreshUnitsDom.apply(this, [a]),
            c._applyEffectSwitch.apply(this, [i.effectType])) : (t = e.extend(t, t.data("syotimer-blocks")),
            i.afterDeadline(t))
        },
        _refreshUnitsDom: function(i) {
            ...
            for (var d = 0; d < a.length; d++) {
                ...
                e(".syotimer-cell__value", m).html(y.format2(u, l !== t && o.doubleNumbers)),
                e(".syotimer-cell__unit", m).html(e.syotimerLang.getNumeral(u, o.lang, l))
            }
        },
      ...
      , y = {
        ...
        getDifferenceWithTimezone: function(e, t, o) {
            var r, a = t.getTime() - e.getTime(), s = 0, d = 0;
            if ("local" !== o.timeZone) {
      ...
      , p = {
        setOption: function(t, i) {
            var n = e(this)
              , o = n.data("syotimer-options");
            o.hasOwnProperty(t) && (o[t] = i,
            n.data("syotimer-options", o))
        }
    };
